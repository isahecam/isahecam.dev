...
export async function Hero() {
  ...
  return (
    <section className="relative w-full max-w-3xl rounded-4xl">
      <div className="mx-auto flex w-full flex-col gap-16 px-4 py-8">
        <StarsBackground
          className={cn(
            "absolute inset-0 -z-10 flex items-center justify-center rounded-xl",
            "bg-[radial-gradient(ellipse_at_bottom,#f5f5f5_0%,#fff_100%)] mask-radial-[100%_100%] mask-radial-from-65% mask-radial-at-right dark:bg-[radial-gradient(ellipse_at_bottom,#262626_0%,#000_100%)]",
          )}
        />
